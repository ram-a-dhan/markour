...
export const NOTES_PURGE_API_PATH = NOTES_API_PATH + "/purge";
export const TAGS_API_PATH = API_PATH + "/tags";
export const TAGS_BY_ID_API_PATH = (id: string) => `${TAGS_API_PATH}/${id}`;
